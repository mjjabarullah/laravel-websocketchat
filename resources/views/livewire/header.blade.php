<div x-data="{ showMenu: false}" @click.away="showMenu= false" class="z-50 h-12 lg:h-14 flex  flex-none w-full items-center justify-between shadow-md shadow-primary/30 ">
    <div class="flex w-full items-center flex-1 h-full justify-between bg-primary-800 lg:bg-primary-900 text-white">
        <div class="h-full flex pl-2 gap-4 items-center">
            ...
            <div class="flex flex-col ">
                ...
                <p class="font-light  text-[10px] lg:text-[12px]">#{{$room->slug}}</p>
            </div>
        </div>
        <div class="h-full flex lg:w-80 justify-end items-center gap-2 pr-1">
            <svg class="w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <button @click="showMenu = !showMenu">
                <svg class="w-12 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div
        x-cloak
        x-show="showMenu"
        class="rounded-xl ease-in-out transition duration-1000 border border-gray-200 absolute top-14 right-0 flex flex-col bg-white w-52 lg:w-60 drop-shadow-lg"
    >
